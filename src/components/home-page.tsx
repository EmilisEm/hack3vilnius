...
export default function HomePage() {
    ...
    const addStop = () => {
        if (stops.length < 5) {  // Limit to 5 stops for this example
            setStops([...stops, ''])
        }
    }
    ...
    return (
        <div className="flex flex-col h-full bg-background">
            <main className="flex-1 overflow-hidden flex flex-col relative">
                <div className="border rounded-lg p-2 mx-2 space-y-4">
                    <ScrollArea className="h-[25vh] border rounded-md px-2 pt-2">
                            ...
                            <div key={index} className="flex items-center space-x-2 mb-2">
                                ...
                                <div className="flex w-full items-center space-x-2">
                                    <Input
                                        ...
                                        placeholder={index === 0 ? "Start" : index === stops.length - 1 ? "End" : `Stop ${index}`}
                                        value={stop}
